...
const NAV = [
  ...
  { id: 'review', label: 'Needs Review', icon: AlertTriangle, badge: '8' },
 ...
 */
export function Sidebar({ active, onNavigate, mobileOpen, onMobileClose }) {
      ...
      >
        ...
        <div className="border-t border-slate-100 p-4">
          <div className="rounded-lg bg-surface-muted p-3">
            <p className="text-xs font-semibold text-ink">Sample data</p>
            <p className="mt-0.5 text-[11px] text-ink-muted">
              Phase 1 — connect CSVs in Phase 2
            </p>
          </div>
        </div>
      </aside>
